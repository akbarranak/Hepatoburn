...
export default function GuaranteeSection() {
  ...
  return (
    <section className="w-full bg-[#F3E8E8] py-6 md:py-10">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-6xl mx-auto">
          ...
          <div className="md:w-3/5 space-y-4 md:space-y-6">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#8A1C1C] font-heading text-center md:text-left">
            ...
            <p className="text-base sm:text-lg md:text-xl font-body text-center md:text-left text-black">
              We're so confident that HepatoBurn will deliver the results you're looking for that we're backing it with
            ...
            <div className="space-y-4 mt-4 md:mt-6">
              <div className="flex items-start gap-3 md:gap-4">
                <div className="mt-1 flex-shrink-0">
                  <Clock className="h-6 w-6 md:h-8 md:w-8 text-[#8A1C1C]" />
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-[#8A1C1C] font-heading">
                    Try HepatoBurn For 60 Days
                  </h3>
              ...
              <div className="flex items-start gap-3 md:gap-4">
                <div className="mt-1 flex-shrink-0">
                  <RotateCcw className="h-6 w-6 md:h-8 md:w-8 text-[#8A1C1C]" />
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-[#8A1C1C] font-heading">
            ...
            <div className="pt-4 md:pt-6 text-center md:text-left">
              <ShineButton
                className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold text-sm sm:text-base md:text-lg lg:text-xl px-6 sm:px-8 md:px-10 py-2 sm:py-3 md:py-4 lg:py-6 rounded-full w-full sm:w-auto"
