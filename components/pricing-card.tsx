          ...
          <div className="relative h-56 md:h-64 w-full max-w-[280px] mx-auto">
            ...
            <div className="w-full h-full flex flex-col justify-center items-center">
              <div className="relative" style={{ width: "140px", height: "200px" }}>
                ...
                {/* Quantity badge */}
                <div className="absolute -right-4 -top-4 bg-red-600 text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl shadow-lg border-2 border-white">
                  x{bottleCount}
                </div>
              </div>

              {/* Text description of quantity */}
              <p className="mt-4 font-bold text-lg text-red-800 font-heading">
