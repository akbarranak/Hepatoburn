        ...
        <div className="p-2 sm:p-3 md:p-4 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <motion.div
              ...
              className="w-2 h-2 sm:w-3 sm:h-3 bg-[#8A1C1C] rounded-full"
            ></motion.div>
            <span className="font-bold text-black uppercase tracking-wider text-xs sm:text-sm md:text-base">
              Limited Time Offer
            </span>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-md sm:rounded-lg px-2 sm:px-3 py-1 border border-white border-opacity-30">
              <span className="font-mono font-bold text-sm sm:text-lg md:text-xl lg:text-2xl text-black">
                {String(timeLeft.minutes).padStart(2, "0")}
              </span>
            </div>
            <span className="font-bold text-black text-sm sm:text-lg md:text-xl">:</span>
            {/* Seconds */}
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-md sm:rounded-lg px-2 sm:px-3 py-1 border border-white border-opacity-30">
              <span className="font-mono font-bold text-sm sm:text-lg md:text-xl lg:text-2xl text-black">
